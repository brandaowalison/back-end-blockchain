...
// Cadastra uma nova transação de compensação
...
// Lista todas as transações de compensação
...
// Busca uma transação de compensação por ID
...
// Atualiza uma transação de compensação por ID
...
// Deleta uma transação de compensação por ID
